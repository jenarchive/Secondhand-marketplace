...
* Making it more engaging and challenging for student
* Badges is an important game element, which is used to boot the motivation of learners when they study
...
* Key dimensions for user experience:
    ...
    * Autotelics: Does it feel good in and of itself? - Positive haptic exp partially achieved through touch feedback feeling pleasant, independent of its purpose in the system. e.g.The satisfying "click" of a well-made physical dial or button.
    * Immersion: Do you feel immersed? - Level of engagement in system / application. e.g. Wearable vests that make you feel the rumble of an engine all around you.
    * Realism: Does it feel realistic? - whether effect convincingly portrays what is expected to feel in reality. e.g. A VR medical tool that feels exactly like cutting through different layers of tissue.
* Usability requirements:
    * Utility - Is it useful?
    * Causality - Can you identify the cause of feedback?
...
* benefits of applying gamification:
    ...
    * Increasing brand recall, expand brand awareness and positive attitude toward the brand
    * Creating competitive advantage
    * Interactive brand design
    * Supporting crowdsourcing in the tourism industry
    * Improving customer experience
    * Encouraging customer engagement with marketing activities
...
* Suggestion:
    * Horizontal swiping is primary method for: switching between pages, browsing galleries, watching tutorials.
    * Vertical swiping for continuous data: long lists, scanning for specific information quickly
    * Increase accessibility: larger swipe zones, prevent accidental triggers
    * Provide feedback: visual feedback & haptic/audio cues
    * Minimize complexity: single-finger swipes in predictable directions to keep the learning curve low and prevent user frustration.




### [Defining gamification: a service marketing perspective](https://dl.acm.org/doi/abs/10.1145/2393132.2393137)
* Provides definition of gamification

To search: 
visitor activation, user retention, smart gamification